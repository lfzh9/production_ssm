...
<table class="easyui-datagrid" id="messageList" title="消息列表" data-options="singleSelect:false,collapsible:true,
    ...
    <thead>
        <tr>
			...
			<th data-options="field:'type',align:'center',width:100">消息类别</th>
			<th data-options="field:'person',align:'center',width:100">发布人</th>
...
<div  id="toolbar_message" style=" height: 22px; padding: 3px 11px; background: #fafafa;">  
    ...
    <div id="search_message" style="float: right;">
        ...
        <div id="menu_message" style="width:120px"> 
			...
			<div data-options="name:'person'">发布人</div> 
			<div data-options="name:'time'">发布时间</div> 
		</div>     
    </div>  
</div>  
	...
	if(value == null || value == ''){
		...
		$("#messageList").datagrid({
	        ...
	        columns : [ [ 
				...
				{field : 'person', width : 100, align : 'center', title : '发布人'},
       		...
       		if(data.msg != null){
               	...
               	$("#messageEditWindow").window({
               		onLoad :function(){
               			...
               			$("#messageEditWindow").form("load", data);
               		}
               	}).window("open");
       		}
       	});
