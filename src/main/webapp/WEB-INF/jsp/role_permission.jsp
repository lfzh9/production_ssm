...
<div style="padding:10px 10px 10px 10px">
	<form id="permissionForm" class="itemForm" method="post"> 
			...
			<label><input name="permissionOption" type="checkbox" value="275" />机构新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="276" />机构修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="277" />机构删除 </label> 
			<br><br>
