...
<<<<<<< Updated upstream
		...
		<label><input name="permissionOption1" type="checkbox" value="283" />消息删除 </label> 
		<br><br>
		<span style="font-weight: bold;">我的日程：</span>
		<label><input name="permissionOption1" type="checkbox" value="501" />日程新增 </label> 
		<label><input name="permissionOption1" type="checkbox" value="502" />日程修改 </label> 
		<label><input name="permissionOption1" type="checkbox" value="503" />日程删除 </label> 
		<br><br>
